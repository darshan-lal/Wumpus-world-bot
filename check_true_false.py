...
def main(argv):
    ...
    state = statement
    ttentails = entailmentcheck(knowledge_base, state)
    ...
    try:
        ...
        elif ((True in ttentails) and (False in ttentails)):
        ...
        print "unable to write output in result.txt file"
        sys.exit(1)
